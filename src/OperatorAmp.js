...
class OperatorAmp {
  constructor(amp) {
    ...
    this.parts = {
	prism: (items.find((item) => item.uniqueName === amp.modularParts.LWPT_AMP_OCULUS)) || {uniqueName: amp.modularParts.LWPT_AMP_OCULUS},
	scaffold: (items.find((item) => item.uniqueName === amp.modularParts.LWPT_AMP_CORE)) || {uniqueName: amp.modularParts.LWPT_AMP_CORE},
      brace: (items.find((item) => item.uniqueName === amp.modularParts.LWPT_AMP_BRACE)) || {uniqueName: amp.modularParts.LWPT_AMP_BRACE},
    };
